...
class TMDBIntegrator:
    ...
    def search_movie(self, title: str, year: Optional[str] = None) -> Optional[Dict]:
        ...
        data = self._make_request(f"{self.base_url}/search/movie", params)
    ...
    def search_tv(self, title: str, year: Optional[str] = None) -> Optional[Dict]:
        ...
        data = self._make_request(f"{self.base_url}/search/tv", params)
        if data and data.get('results'):
            return data['results'][0]
        return None
    ...
    def get_movie_details(self, movie_id: int) -> Optional[Dict]:
        ...
        return self._make_request(f"{self.base_url}/movie/{movie_id}", params)
    ...
    def get_tv_details(self, tv_id: int) -> Optional[Dict]:
        ...
        return self._make_request(f"{self.base_url}/tv/{tv_id}", params)
    ...
    def get_tv_season_details(self, tv_id: int, season_number: int) -> Optional[Dict]:
        ...
        return self._make_request(f"{self.base_url}/tv/{tv_id}/season/{season_number}", params)
    ...
    def format_movie_data(self, tmdb_data: Dict, original_sources: List[Dict]) -> Dict:
        ...
        return {
            ...
            "duration": f"{tmdb_data.get('runtime', 143)}:00" if tmdb_data.get('runtime') else "143:00",
            ...
            if season_info and season_info.get('episodes'):
                for ep_num, episode in enumerate(season_info['episodes'][:1], 1):  # 1 episode per season as requested
                    ...
                    episodes.append({
                        ...
                        "duration": "47:00",  # Default duration
...
def main():
    ...
    if avengers_search:
        ...
        if avengers_details:
            ...
            original_data['home']['slides'][0]['image'] = ""
